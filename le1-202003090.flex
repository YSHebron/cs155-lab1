...
RESERVED    PROCEDURE|VAR|INTEGER|REAL|BOOLEAN|STRING|WRITELN|IF|THEN|ELSE|WHILE|DO|FOR|TO|DOWNTO|BEGIN|END
RELOP       "="|"<>"|"<"|"<="|">"|">="
LOGOP       AND|OR|NOT
...
{NUMBER}({IDENT}|{BADPUNCTS}|{NUMBER})*      { yyerror("lexical error");}
{IDENT}({IDENT}|{BADPUNCTS}|{NUMBER})*       { yyerror("lexical error");}
